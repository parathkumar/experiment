...
import { SuccessAlertComponent } from '@shared/components';
...
export class CustomerActionsModalComponent implements OnInit {
  ...
  modalType:string;
  form!: FormGroup;
  constructor(private formBuilder : FormBuilder,@Inject(MAT_DIALOG_DATA) data:any,private customerService:CustomersService,private dialog:MatDialog,private customerActionModalRef:MatDialogRef<CustomerActionsModalComponent>) {
