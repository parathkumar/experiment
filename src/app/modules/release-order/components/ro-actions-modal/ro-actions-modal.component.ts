...
export class RoActionsModalComponent implements OnInit {
  ...
  modalType:string;
  roFormValues:IReleaseOrder;
  form!: FormGroup;
  customerList:any;
  publicationList:any;
  regionList:any;
  selectedDates:any[] = [];
  constructor(private formBuilder : FormBuilder,@Inject(MAT_DIALOG_DATA) data: any,private releaseOrderService:ReleaseOrderService,private dialog:MatDialog,private roActionsModalRef:MatDialogRef<RoActionsModalComponent>,private customerService:CustomersService,private publicationService:PublicationsService,private regionService:RegionsService,private selectedDatesService:AdvancedDatepickerService) { 
